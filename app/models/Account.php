...
class Account extends Model {
    ...
    public function register($post) {
        ...
        $this->db->query("INSERT INTO Accounts (email, login, password, token, status) VALUES (:email, :login, :password, :token, :status)", $params);

        mail($post['email'], 'Register', 'Confirm: http://lab-4/account/confirm/' .$token);
    }
    ...
    public function recovery($post) {
        ...
        mail($post['email'], 'Recovery', 'Confirm: http://lab-4/account/reset/' .$token);
